...
def create_genesis_file(public_key):
    genesis_string = '{ "config": { "chainId": 1231234512, "homesteadBlock": 0, "eip150Block": 0, "eip155Block": 0, "eip158Block": 0, "byzantiumBlock": 0, "constantinopleBlock": 0, "petersburgBlock": 0, "clique": { "period": 5, "epoch": 30000 } }, "difficulty": "1", "gasLimit": "8000000", "extradata": "0x000000000000000000000000{0}", "alloc": { "{0}": { "balance": "0xfffffffffffffffffffffffffffffff" } } }'#.format(public_key[public_key.find('x') + 1:])
